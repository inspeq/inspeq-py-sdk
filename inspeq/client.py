...
class Evaluator:
    ...
    def narrative_continuity(self, input_data):
        # Validate input_data
        response_data = input_data.get("response", "").strip()
        if not response_data:
            raise ValueError("'response' is not provided")
        ...
        return self.make_api_request("narrative_continuity", input_data)
    ...
    def get_all_metrics(self, input_data):
        ...
        metrics_results["narrative_continuity"] = self.narrative_continuity(input_data)
